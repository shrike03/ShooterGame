...
class Control():
    ...
    def tick(self):
        for button_name, (text_render, x_pos, y_pos) in self.controls.items():
            ...
            if self.hitbox.collidepoint(pygame.mouse.get_pos()) and self.active_button is None:
                if pygame.mouse.get_pressed()[0]:
                    self.active_button = button_name
                    
                    print(f'kliknięty{button_name}')
                ...
                if self.active_button is not None:                  
                    ...
                    if event.key == pygame.K_BACKSPACE:
                        ...
                        if event.key in self.specials_buttons:
                            ...
                            # Dodawanie wprowadzonego znaku do input_text
